...
class Post(models.Model):
    ...
    nutrition_photo = models.ImageField('영양성분표 이미지', blank=True, null=True, upload_to='nutrition/%Y%m%d')
    calorie = models.FloatField('칼로리(kcal)')
    carbohydrate = models.FloatField('탄수화물(g)')
